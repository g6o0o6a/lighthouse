...
/**
 * @fileoverview Script to bundle lighthouse entry points so that they can be
 * run in the browser (as long as it has access to a debugger protocol Connection).
 */
